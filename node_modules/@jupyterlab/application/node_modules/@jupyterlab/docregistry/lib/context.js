...
export class Context {
                ...
                if (change.name === 'path') {
                    ...
                    if (this._path !== newPath) {
                        ...
                        if (this._contentsModel) {
                            const contentsModel = Object.assign(Object.assign({}, this._contentsModel), { name: name, path: newPath });
    ...
    _onSessionChanged(sender, type) {
        ...
        if (path !== this._path) {
            ...
            if (this._contentsModel) {
                const contentsModel = Object.assign(Object.assign({}, this._contentsModel), { name: name, path: path });
                this._updateContentsModel(contentsModel);
            }
            this._model.sharedModel.setState('path', localPath);
